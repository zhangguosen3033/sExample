...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    offscreenAnimation.toValue = @(fromVC.view.layer.position.y*3);
    ...
    scaleAnimationFromView.toValue=[NSValue valueWithCGPoint:CGPointMake(1, 1)];
    
    [toVC.view.layer pop_addAnimation:scaleAnimationFromView forKey:@"scaleAnimationFromView1"];
}
