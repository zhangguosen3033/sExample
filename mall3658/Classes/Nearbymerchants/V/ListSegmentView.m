...
@implementation ListSegmentView
-(instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titleArray btn_w:(CGFloat)btn_w clickBlick:(btnClickBlock)block{
    ...
    if (self) {
        ...
        _bgScrollView=[[ScrollView alloc] initWithFrame:CGRectMake(0, 0, windowContentWidth, self.frame.size.height)];
