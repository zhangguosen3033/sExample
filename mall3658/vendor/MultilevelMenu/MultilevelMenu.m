...
-(id)initWithFrame:(CGRect)frame WithData:(NSArray *)data withSelectIndex:(void (^)(NSInteger, NSInteger, id))selectIndex
{
    ...
    if (self  == [super initWithFrame:frame]) {
        ...
        /**
         左边的视图
        */
        self.leftTablew=[[TableView alloc] initWithFrame:CGRectMake(0, 0, kLeftWidth, frame.size.height)];
        ...
        float leftMargin =0;
        self.rightCollection=[[CollectionView alloc] initWithFrame:CGRectMake(kLeftWidth+leftMargin,0,kScreenWidth-kLeftWidth-leftMargin*2,frame.size.height) collectionViewLayout:flowLayout];
